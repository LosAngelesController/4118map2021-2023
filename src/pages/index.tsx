    ...
    <div className="flex flex-col h-full w-screen absolute">
      ...
      >
        <Head>
          ...
          />
          <title>City of LA 41.18 Arrests (1/1/21 - 12/31/2024) | Map</title>
          ...
          <meta
            name="twitter:title"
            key="twittertitle"
            content="City of LA 41.18 Arrests (1/1/21 - 12/31/2024) | Map"
          ></meta>
          <meta
            name="twitter:description"
            key="twitterdesc"
            content="City of LA 41.18 Arrests (1/1/21 - 12/31/2024)"
          ></meta>
          <meta
            name="twitter:image"
            key="twitterimg"
          ...
          <meta
            property="og:url"
            content="https://4118recentarrests.lacontroller.app"
          />
          <meta property="og:type" content="website" />
          <meta
            property="og:title"
